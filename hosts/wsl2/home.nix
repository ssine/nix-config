...

{
  ...
  programs.zsh = (import ../../modules/home-manager/zsh) {
    ...
    rcAppend = ''
      ...
      __conda_setup="$('/home/sine/opt/miniconda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
      if [ $? -eq 0 ]; then
          eval "$__conda_setup"
      else
          if [ -f "/home/sine/opt/miniconda/etc/profile.d/conda.sh" ]; then
              . "/home/sine/opt/miniconda/etc/profile.d/conda.sh"
          else
              export PATH="/home/sine/opt/miniconda/bin:$PATH"
          fi
      fi
      unset __conda_setup
      # <<< conda initialize <<<

      export PATH="/home/sine/.npm-packages/bin:/home/sine/.nix-profile/bin:$PATH:/mnt/c/Program Files/Docker/Docker/resources/bin/:/mnt/c/Program Files/Microsoft VS Code/bin"
    '';
  };
